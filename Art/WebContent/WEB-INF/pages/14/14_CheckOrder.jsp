...
<form action="<c:url value='/04/shoppingcart2.ctrl' /> " method="get">
    <table>
        <tr>
    ...
    <table>
        ...
        <tr>
        <td><img class="" src="${pageContext.servletContext.contextPath}/14/getBlobImage/${anEntry.value.productId}.ctrl" alt="" width="50" height="50">						
        </td>
        ...
        <td colspan="5" style="text-align :right">總計：${carList.subtotal}</td>
    </tr>
    </table>
    </form>
   ...
   <input type="button" name="OrderBtn" class="genric-btn info" value="確定送出" onclick="reconfirmOrder();">
<!--    <input type="button" name="btn" id="btn" value="確定送出" > -->

   <input type="button" name="CancelBtn" class="genric-btn danger" value="取消訂單" onclick="cancelOrder();">
