...
public class CourseMailInfo {
	
	public static String courseMailInfo(Set<Map<String, CourseOrderItems>> set, CourseOrders cos) {
		...
		String CMInfo = 
				"\r\n" + 
						...
						"                   <table cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" role=\"presentation\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px\"> \r\n" + 
						"                     <tr style=\"border-collapse:collapse\"> \r\n" + 
						"                      <td align=\"center\" style=\"padding:0;Margin:0;padding-bottom:5px;padding-top:10px\"><h2 style=\"Margin:0;line-height:30px;mso-line-height-rule:exactly;font-family:Poppins, sans-serif;font-size:25px;font-style:normal;font-weight:bold;color:#00413F\">親愛的 "+cos.getmemberId()+" 先生／小姐，您好!<br>感謝您在得藝的一天購買藝文課程</h2></td> \r\n" + 
						"                     </tr> \r\n" + 
						"                     <tr style=\"border-collapse:collapse\"> \r\n" + 
						"                      <td align=\"center\" style=\"padding:0;Margin:0;padding-top:10px;padding-bottom:10px\"><p style=\"Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:15px;font-family:tahoma, verdana, segoe, sans-serif;line-height:23px;color:#333333\">訂單編號："+cos.getOrderNoCo()+"<br>訂購人："+cos.getmemberId()+"<br>電子郵件："+cos.getEmail()+"<br>地址："+cos.getCustomerAddress()+"<br>訂購日期："+cos.getDate()+"<br>總金額："+cos.getTotalAmount()+"</p></td> \r\n" + 
						"                     </tr> \r\n" +
						"                     <tr style=\"border-collapse:collapse\"> \r\n" + 
...
//		String part2 = "";
//		
//		Iterator<Map<String, CourseOrderItems>> iterator = set.iterator();
//		int num = 0;
//		while(iterator.hasNext()) {
//			Map<String, CourseOrderItems> map = iterator.next();
//			Set<String> keySet = map.keySet();
//			
//				for (String str : keySet) {
//					part2+="<tr bgColor='FFFFFF' height='30'>" + 
//							"<td align='center'>"+map.get(str).getOrderIdCo()+"</td>" +
//							"<td align='center'>"+map.get(str).getCourseTitle()+"</td>" +
//							"<td align='center'>"+map.get(str).getCoursePrice()+"</td>" +
//							"<td align='center'>"+map.get(str).getCourseNum()+"</td>" +
//							"<td align='center'>"+(map.get(str).getCourseNum())*(map.get(str).getCoursePrice())+"</td>";
//					num+=(map.get(str).getCourseNum())*(map.get(str).getCoursePrice());
//		
//		
//				}
//				part2 += "<td align='center'>"+num+"</td></tr>";
//		}
//		return CMInfo+part2;
    ...
    public static Set<Map<String, CourseOrderItems>> mailList(CourseOrders cos) {
		
		Set<CourseOrderItems> items = cos.getCourseOrderItems();

		Set<Map<String, CourseOrderItems>> set = new HashSet<Map<String,CourseOrderItems>>();
		for (CourseOrderItems co : items) {
			Map<String, CourseOrderItems> map = new HashedMap();
			map.put(Integer.toString(co.getOrderIdCo()), co);
			map.put(co.getCourseTitle(), co);
			set.add(map);
