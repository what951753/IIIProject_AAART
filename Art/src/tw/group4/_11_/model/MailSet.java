...
public class MailSet {
	...
	private DonateRecordBean dBean;
	
	public static String mailSet(Set<Map<String, DonateRecordBean>> set, DonateRecordBean drb) {
		...
		String htmlFormatBodyContent1 = "<TABLE\r\n" + 
				...
				"                                <th id='borderA' width=\"100px\" align=\"center\">會員名稱</th>\r\n" + 
				"                                <th id='borderA' width=\"70px\" align=\"center\">藝人</th>\r\n" + 
				"                                <th id='borderA' width=\"50px\" align=\"center\">金額</th>\r\n" + 
				"                                <th id='borderA' width=\"100px\" align=\"center\">時間</th>\r\n" + 
				"                              </tr>\r\n" + 
				"\r\n" ;
		...
		String htmlContent = "<tr bgColor='FFFFFF' height='30'>"+
				"<td align='center'>"+ drb.getId_donation() +"</td>" +
				"<td align='center'>"+ drb.getName_user() +"</td>" +
				"<td align='center'>"+ drb.getName_SA() +"</td>" +
				"<td align='center'>"+ drb.getDonate_sa() +"</td>" +
				"<td align='center'>"+ drb.getTime() +"</td>" ;
		
		
//		String htmlContent = "";
//		Iterator<Map<String, DonateRecordBean>> iterator = set.iterator();
//		while(iterator.hasNext()) {
//			Map<String, DonateRecordBean> map = iterator.next();
//			Set<String> keySet = map.keySet();
//			
//				for (String str : keySet) {
//					htmlContent+="<tr bgColor='FFFFFF' height='30'>" + 
//							"<td align='center'>"+map.get(str).getId_donation()+"</td>" +
//							"<td align='center'>"+map.get(str).getName_user()+"</td>" +
//							"<td align='center'>"+map.get(str).getName_SA()+"</td>" +
//							"<td align='center'>"+map.get(str).getDonate_sa()+"</td>" +
//							"<td align='center'>"+map.get(str).getTime()+"</td>";
//				}
//		}
	...
	public static Set<Map<String, DonateRecordBean>> mailListSA(DonateRecordBean drb) {
		
//		Set<DonateRecordBean> items = drb.getItems();

//		Set<Map<String, Object>> set = new HashSet<Map<String,Object>>();
		Set<Map<String, DonateRecordBean>> set = new HashSet<Map<String,DonateRecordBean>>();
		
//		for (DonateRecordBean ap : items) {
//			Map<String, DonateRecordBean> map = new HashedMap();
//			map.put(Integer.toString(ap.getId_donation()), ap);
